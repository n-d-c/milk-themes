...
<Head_HTML {title} {description} keywords={$milk?.site?.keywords}>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-MBG8CFV');
	</script>
	<!-- End Google Tag Manager -->
	<!-- Google Tag Manager (noscript) -->
	<noscript
		><iframe
			src="https://www.googletagmanager.com/ns.html?id=GTM-MBG8CFV"
			height="0"
			width="0"
...
<script>
	...
	import Block_WP_BlogListingByCategory from '$milk/lib/Block_WP_BlogListingByCategory.svelte';
