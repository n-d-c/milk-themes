export const preload_attorneys = [
	...
	},
	{
		...
		Attorney: {
			...
			jpegImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_laurenanselowitz.jpg',
			},
			webpImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_laurenanselowitz.webp',
			},
		},
	},
	{
		...
		Attorney: {
			...
			jpegImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_maggiedunsmuir.jpg',
			},
			webpImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_maggiedunsmuir.webp',
			},
		},
	},
	{
		...
		Attorney: {
			additionalDescription:
				'<p>Riki King handles a great deal of employment and family immigration cases. Additionally she appears often with clients in Immigration Court and at the Immigration Service offices in many states.</p>\n<p>She also spent several years as an attorney with a large international law firm in New York, where she handled complex litigation issues. Her accolades include the Legal Aid Society’s 2007 and 2011 pro bono awards.</p>\n<p>Ms. King attended New York Law School where she graduated third in her class. She completed her concentration in Immigration and was Executive Notes Editor of the Law Review as well as a John Marshall Harlan Scholar. She also holds a Bachelor’s Degree from Colgate University. Additionally, she studied in both Spain and Wales.</p>\n<p>A member of the American Immigration Lawyers Association, Ms. King is admitted to practice in New York and Massachusetts.</p>\n',
			email: 'RKing@ImmigrationLawNJ.com',
			avifImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_rikiking.avif',
			},
			shortDescription:
			...
			jpegImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_rikiking.jpg',
			},
			webpImage: {
				sourceUrl:
					'https://admin.immigrationlawnj.com/wp-content/uploads/2021/04/attorney_rikiking.webp',
			},
		},
	},
];

export const preload_faqs = [
	{
	...
	},
	{
		...
		"title": "Green Cards",
		"FAQ": {
			"answer": "<p>There are a variety of ways to get your green card.  At Harlan York &amp; Associates, we know them all, including obscure parts of immigration law that you will not hear about from “jack of all trades” lawyers.</p>\n"
		}
	}
];

export const preload_featured = [
	{
...
export const preload_testimonials = [
	{
		"Testimonial": {
			"avifImage": {
