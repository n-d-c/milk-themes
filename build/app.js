...
const manifest = {
  ...
  pages: [
    ...
    },
    {
      ...
      css: ["assets/start-521e4825.css", "assets/pages/immigration-law-services/[slug].svelte-32902e7f.css", "assets/Block_ServicesList.svelte-9fe10500.css", "assets/Layout_Main-7c5991fa.css", "assets/Block_Ratings-154e98f1.css", "assets/Block_CallOutText-7690976a.css", "assets/Block_LanguagesWeSpeak-4fc5fae9.css", "assets/Block_Testimonials-f757a741.css", "assets/FeaturedVideo-4c2ed0ff.css"],
      js: ["start-b248021d.js", "chunks/index-b6a42182.js", "chunks/milk-0fba135e.js", "pages/immigration-law-services/[slug].svelte-c778db19.js", "chunks/Head_Article-304c0607.js", "chunks/Head_Twitter-0458c92f.js", "chunks/Layout_Main-21e6a800.js", "chunks/Block_Ratings-49a8d14b.js", "chunks/Block_CallOutText-f8620481.js", "chunks/Block_LanguagesWeSpeak-ae46a675.js", "chunks/Block_Testimonials-70bbe164.js", "chunks/FeaturedVideo-b0ea6aef.js"]
    },
    {
      ...
      js: ["start-b248021d.js", "chunks/index-b6a42182.js", "chunks/milk-0fba135e.js", "pages/immigration-information/index.svelte-cf93dbb0.js", "chunks/Head_Twitter-0458c92f.js", "chunks/Layout_Main-21e6a800.js"]
    },
    {
      pattern: /^\/immigration-information\/([^/]+?)\/?$/,
    ...
    },
    {
      ...
      js: ["start-b248021d.js", "chunks/index-b6a42182.js", "chunks/milk-0fba135e.js", "pages/fonttest.svelte-05962535.js"]
    },
    {
      pattern: /^\/espanol\/?$/,
      params: empty,
    ...
    },
    {
      ...
      css: ["assets/start-521e4825.css", "assets/Layout_Main-7c5991fa.css"],
      js: ["start-b248021d.js", "chunks/index-b6a42182.js", "chunks/milk-0fba135e.js", "pages/test.svelte.md-a58c7b83.js", "chunks/Layout_Main-21e6a800.js"]
    }
  ],
  endpoints: []
};
...
var Block_FaqItem_svelte = ".single-faq-wrap.svelte-193lzp6.svelte-193lzp6{display:flex;grid-gap:15px;gap:15px;width:auto;flex:1}.icon-wrap.svelte-193lzp6.svelte-193lzp6{position:relative;width:40px;height:40px}.faq-content.svelte-193lzp6.svelte-193lzp6{flex:1}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6{position:absolute;display:block;background-color:var(--color-black)}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6:first-child{height:16%;width:100%;top:50%;margin-top:-8%}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6:nth-child(2){height:100%;width:16%;left:50%;margin-left:-8%;transform-origin:center;transition:transform .2s ease-in}[aria-expanded=true].svelte-193lzp6 i.svelte-193lzp6:nth-child(2){transform:rotate(90deg)}";
const css$c = {
  code: ".single-faq-wrap.svelte-193lzp6.svelte-193lzp6{display:flex;grid-gap:15px;gap:15px;width:auto;flex:1}.icon-wrap.svelte-193lzp6.svelte-193lzp6{position:relative;width:40px;height:40px}.faq-content.svelte-193lzp6.svelte-193lzp6{flex:1}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6{position:absolute;display:block;background-color:var(--color-black)}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6:first-child{height:16%;width:100%;top:50%;margin-top:-8%}.icon-wrap.svelte-193lzp6 i.svelte-193lzp6:nth-child(2){height:100%;width:16%;left:50%;margin-left:-8%;transform-origin:center;transition:transform .2s ease-in}[aria-expanded=true].svelte-193lzp6 i.svelte-193lzp6:nth-child(2){transform:rotate(90deg)}",
  map: `{"version":3,"file":"Block_FaqItem.svelte","sources":["Block_FaqItem.svelte"],"sourcesContent":["<div class=\\"single-faq-wrap\\">\\n\\t<div on:click={toggle} aria-expanded={isOpen} class=\\"icon-wrap\\">\\n\\t\\t<i />\\n\\t\\t<i />\\n\\t</div>\\n\\t<div class=\\"faq-content\\">\\n\\t\\t<h3>{title}</h3>\\n\\n\\t\\t{#if isOpen}\\n\\t\\t\\t<div transition:slide={{ duration: 300 }} class=\\"dropdown\\">\\n\\t\\t\\t\\t<p>{content}</p>\\n\\t\\t\\t</div>\\n\\t\\t{/if}\\n\\t</div>\\n</div>\\n\\n<script>import { slide } from 'svelte/transition';\\nvar isOpen = false;\\n\\nvar toggle = () => isOpen = !isOpen;\\n\\nvar title, content;\\nexport { title, content };</script>\\n\\n<style>.single-faq-wrap{display:flex;grid-gap:15px;gap:15px;width:auto;flex:1}.icon-wrap{position:relative;width:40px;height:40px}.faq-content{flex:1}.icon-wrap i{position:absolute;display:block;background-color:var(--color-black)}.icon-wrap i:first-child{height:16%;width:100%;top:50%;margin-top:-8%}.icon-wrap i:nth-child(2){height:100%;width:16%;left:50%;margin-left:-8%;transform-origin:center;transition:transform .2s ease-in}[aria-expanded=true] i:nth-child(2){transform:rotate(90deg)}</style>\\n"],"names":[],"mappings":"AAwBO,8CAAgB,CAAC,QAAQ,IAAI,CAAC,SAAS,IAAI,CAAC,IAAI,IAAI,CAAC,MAAM,IAAI,CAAC,KAAK,CAAC,CAAC,wCAAU,CAAC,SAAS,QAAQ,CAAC,MAAM,IAAI,CAAC,OAAO,IAAI,CAAC,0CAAY,CAAC,KAAK,CAAC,CAAC,yBAAU,CAAC,gBAAC,CAAC,SAAS,QAAQ,CAAC,QAAQ,KAAK,CAAC,iBAAiB,IAAI,aAAa,CAAC,CAAC,yBAAU,CAAC,gBAAC,YAAY,CAAC,OAAO,GAAG,CAAC,MAAM,IAAI,CAAC,IAAI,GAAG,CAAC,WAAW,GAAG,CAAC,yBAAU,CAAC,gBAAC,WAAW,CAAC,CAAC,CAAC,OAAO,IAAI,CAAC,MAAM,GAAG,CAAC,KAAK,GAAG,CAAC,YAAY,GAAG,CAAC,iBAAiB,MAAM,CAAC,WAAW,SAAS,CAAC,GAAG,CAAC,OAAO,CAAC,CAAC,aAAa,CAAC,IAAI,gBAAC,CAAC,gBAAC,WAAW,CAAC,CAAC,CAAC,UAAU,OAAO,KAAK,CAAC,CAAC"}`
};
const Block_FaqItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css$c);
  return `<div class="${"single-faq-wrap svelte-193lzp6"}"><div${add_attribute("aria-expanded", isOpen, 0)} class="${"icon-wrap svelte-193lzp6"}"><i class="${"svelte-193lzp6"}"></i>
		<i class="${"svelte-193lzp6"}"></i></div>
	<div class="${"faq-content svelte-193lzp6"}"><h3>${escape(title)}</h3>
